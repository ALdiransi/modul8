...
// Fungsi binary search untuk mencari huruf dalam string int binarySearch(const string &str, char target)
{
int left = 0;
...
// Melakukan binary search pada kalimat int posisi = binarySearch(kalimat, huruf);

// Mengecek apakah huruf ditemukan atau tidak if (posisi != -1)
{
